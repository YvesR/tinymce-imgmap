tinymce.PluginManager.requireLangPack('imgmap', 'de,en_US,fr_FR');
...
tinymce.PluginManager.add('imgmap', function(ed, url) {
  ...
  ed.addCommand('mceimgmapPopup', function() {
    ...
    ed.windowManager.open({
      id: "imgmap",
      title: tinymce.translate('imgmap.desc'),
      file: url + '/popup.html',
      width: 800,
      height: tinymce.settings.imgmap_settings.dialogHeight || 610,
      buttons: [{
        text: tinymce.translate('imgmap.btnUpdate'),
        onclick: function(e) {
        ...
        text: tinymce.translate('imgmap.btnCancel'),
        onclick: 'close'
      }, {
        text: tinymce.translate('imgmap.btnRemove'),
        onclick: function(e) {
          var iframes = document.getElementsByTagName('iframe');
          var tgtWindow;
          for(var i=0; i<iframes.length; i++){
  ...
  ed.addButton('imgmap', {
    title: tinymce.translate('imgmap.desc'),
    cmd: 'mceimgmapPopup',
    //image: url + '/images/imagemap_16.png',
    icon: 'imgmap',
